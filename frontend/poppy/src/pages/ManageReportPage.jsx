      ...
      <Container>
        ...
        <Content>
          <TimeArea>
            ...
            {currentTime.toLocaleTimeString()} 현재
          </TimeArea>
          {isLoading ? (
            <Loading>
              <h1>잠시만 기다려 주세요...</h1>
                ...
                {currentData &&
                  currentData.map((item, index) => (
                    <GridCard key={index} onClick={() => handleGridClick(item)}>
                      <ContentBox>
                        <PotholeImg
                          src={`http://d1vcrv9kpqlkt7.cloudfront.net/${item.province}+${item.city}+${item.street}/${item.longitude}_${item.latitude}.jpg`}
                          alt="pothole"
                        ></PotholeImg>
                        <ListBox>
                          <List>신고시각 : </List>
        ...
        <InfoModal>
          ...
          <ModalContent>
            <ModalContentBox>
              <ModalContainer>
                <ModalImg
                  src={`http://d1vcrv9kpqlkt7.cloudfront.net/${selectedGrid.province}+${selectedGrid.city}+${selectedGrid.street}/${selectedGrid.longitude}_${selectedGrid.latitude}.jpg`}
                ></ModalImg>
                {selectedGrid && (
                  <ModalTable>
                    <tbody>
                      <TableRow>
                        ...
                        <TableCell2>
                          {selectedGrid.province} {selectedGrid.city}{" "}
                          {selectedGrid.street}
                        </TableCell2>
                      </TableRow>
                      {/* <TableRow>
                      ...
                      <TableRow>
                        ...
                        <TableCell2>
                          {selectedGrid.detectedAt.slice(0, 10)}{" "}
                          {selectedGrid.detectedAt.slice(11, 19)}
                        </TableCell2>
                      </TableRow>
                      {/* <TableRow>
