...
const ManageProcessPage = () => {
  ...
  const handleRegionSelect = (event) => {
    ...
    const sub =
      areas.find((area) => area.name === event.target.value)?.subArea || [];
    setSubAreas(sub);
  ...
  return (
    <Background>
        ...
        <SortedArea>
          <SortedBox>
            ...
            <StateBox>
              ...
              <ReFilterBtn onClick={gotoRefilter}>
                <RefilterImg src={reloadImg2}></RefilterImg>
              </ReFilterBtn>
            </StateBox>
          </SortedBox>
        </SortedArea>
      ...
      {randomCompany && selectedList && isInfoModalOpen && (
        <ListDetailModal>
          <ModalHeader>
          ...
          <ModalContent>
            <ModalContentBox>
              <ModalContainer>
                <ModalImg
                  src={`http://d1vcrv9kpqlkt7.cloudfront.net/${selectedList.province}+${selectedList.city}+${selectedList.street}/${selectedList.longitude}_${selectedList.latitude}.jpg`}
                  alt="No image"
                ></ModalImg>
                <ModalTable>
                  <TableRow>
                  ...
                  <TableRow>
                    ...
                    <TableCell2>
                      {selectedList.province} {selectedList.city}{" "}
                      {selectedList.street}
                    </TableCell2>
                  </TableRow>
                  <TableRow>
                    ...
                    <TableCell2>
                      {selectedList.detectedAt.slice(0, 10)}{" "}
                      {selectedList.detectedAt.slice(11, 19)}
                    </TableCell2>
                  </TableRow>
                  {/* <TableRow>
                  ...
                  <TableRow>
                    ...
                    {selectedList.startAt && (
                      <TableCell2>
                        {selectedList.startAt.slice(0, 10)}
                      </TableCell2>
                    )}
                  </TableRow>
                  <TableRow>
                    ...
                    {selectedList.expectAt && (
                      <TableCell2>
                        {selectedList.expectAt.slice(0, 10)}
                      </TableCell2>
                    )}
                  </TableRow>
                </ModalTable>
